import estilos from './footer.modules.css'
        ...
        <ul className={estilos["example-2"]}>
          <li className={estilos["icon-content"]}>
            ...
            >
              ...
              <svg
                viewBox="0 0 16 16"
                className={estilos["bi-instagram"]}
                fill="currentColor"
                height="16"
                width="16"
            ...
            <div className={estilos.tooltip}>Instagram</div>
          </li>
          <li className={estilos["icon-content"]}>
            <a
            ...
            <div className={estilos.tooltip}>Facebook</div>
          </li>
          ...
          <li className={estilos["icon-content"]}>
            ...
            <div className={estilos.tooltip}>Youtube</div>
          </li>
        </ul>
